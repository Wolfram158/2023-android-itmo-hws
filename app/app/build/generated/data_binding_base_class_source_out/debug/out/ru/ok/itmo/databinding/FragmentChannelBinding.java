...
public final class FragmentChannelBinding implements ViewBinding {
  ...
  @NonNull
  public final Button createMessage;

  @NonNull
  public final RecyclerView recyclerView2;

  private FragmentChannelBinding(@NonNull ConstraintLayout rootView, @NonNull Button createMessage,
  ...
  public static FragmentChannelBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.createMessage;
      Button createMessage = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentChannelBinding((ConstraintLayout) rootView, createMessage, recyclerView2);
    }
