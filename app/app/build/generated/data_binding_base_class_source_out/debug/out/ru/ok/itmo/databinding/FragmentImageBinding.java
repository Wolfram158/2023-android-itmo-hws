...
public final class FragmentImageBinding implements ViewBinding {
  ...
  private FragmentImageBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView2) {
  ...
  public static FragmentImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentImageBinding((ConstraintLayout) rootView, imageView2);
    }
